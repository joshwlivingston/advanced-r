...
<em>1.In the following example, why are object.size(y) and obj_size(y) so radically different?</em>
...
<em>2. Take the following list. Why is its size somewhat misleading?</em>
